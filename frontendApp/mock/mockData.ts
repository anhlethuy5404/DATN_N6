...
export const mockCategories: Category[] = [
  { id: 1, name: 'Điện tử & Máy ảnh', slug: 'dien-tu-may-anh', iconName: 'camera-outline', status: 'ACTIVE', children: ['Máy ảnh film', 'Ống kính cơ', 'Loa cổ'] },
  { id: 2, name: 'Nội thất & Decor', slug: 'noi-that-decor', iconName: 'bed-outline', status: 'ACTIVE', children: ['Bàn ghế gỗ mộc', 'Đèn cổ điển', 'Thảm dệt'] },
  { id: 3, name: 'Đồng hồ & Phụ kiện', slug: 'dong-ho-phu-kien', iconName: 'watch-outline', status: 'ACTIVE', children: ['Đồng hồ cơ', 'Trang sức bạc', 'Kính râm'] },
  { id: 4, name: 'Xe cộ & Phượt', slug: 'xe-co-phuot', iconName: 'bicycle-outline', status: 'ACTIVE', children: ['Xe đạp touring', 'Phụ tùng xe', 'Ván trượt'] },
  { id: 5, name: 'Đồ gia dụng & Bếp', slug: 'gia-dung-bep', iconName: 'cafe-outline', status: 'ACTIVE', children: ['Dụng cụ pha cà phê', 'Dao bếp Nhật', 'Gốm sứ mộc'] }
]
